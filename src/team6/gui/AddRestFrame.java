...
public class AddRestFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AddRestFrame(String sub) {
		setBounds(100, 100, 300, 161);
		...
		JLabel lblNewLabel_2 = new JLabel("변경 : ");
		...
		addBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(subject == null) {
					JOptionPane.showMessageDialog(AddRestFrame.this, "수정하려는 과목이 변경 혹은 삭제되었습니다.","오류",JOptionPane.WARNING_MESSAGE);
					AddRestFrame.this.setVisible(false);
					return;
				}
				if(subject.getRest(assignname.getText()) != null) {
					JOptionPane.showMessageDialog(AddRestFrame.this, "이미 같은 이름의 휴강/인강이 있습니다.","경고",JOptionPane.WARNING_MESSAGE);
					return;
				}
				...
				subject.getRest().add(assignment);
				try {
					Main.saveTimetables();
